<template>
	<div class="page_BuyAskPriceAdd">
		<mt-header title="添加采购询价" fixed>
   		 	<div slot="left">
		  ...
		  <mt-navbar v-model="selected">
		    ...
		    <mt-tab-item id="2">询价明细</mt-tab-item>
		  </mt-navbar>
		  <mt-tab-container v-model="selected">
			   ...
			   <a data-v-4f7ac5e4="" class="mint-cell mint-field" @click="selectClient()">
			   	...
			   	<div class="mint-cell-wrapper">
			   		<div class="mint-cell-title"><!----> 
			   			<span class="mint-cell-text">供应商</span> <!---->
			   		</div> 
			    ...
			    <mt-field  label="询价金额" placeholder="请输入金额" v-model="TotalAmount"></mt-field>
			  ...
			  <mt-tab-container-item id="2" class="tblOrderDet">
			  	...
			  	<div class="addGood" @click="$router.push({name: 'goodList',params: {retPage: 'BuyAskPriceAdd'}})"><img src="../../assets/goto.png"></div>		  
			  </mt-tab-container-item>
		  </mt-tab-container>
  		</div>
	</div>
...
export default {
  ...
  methods: {
  	...
  	selectClient() {
  		this.$router.push({name: 'clientList_Buy', params: {retPage: 'BuyAskPriceAdd'}})
  	},
  	retBuyAskPriceListPage() {
  		this.saveOrderPre()
  		//console.log(this.DetGoodsCodeStr)
  	    this.$router.push({ name: 'BuyAskPriceList' })
  	  
  	},
  	saveOrderPre() { // 初始化报价主表信息
  	...
  	delDet(index,item) {
  		this.TotalAmount -= this.TABLENAME_tblBuyAskPriceDet[index].TaxAmount
